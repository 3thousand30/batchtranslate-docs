...
**Batch Translate Text with any AI** is a Windows desktop app by [3thousand30](https://3thousand30.com) for translating a whole folder of documents — PDF, DOCX, TXT, Markdown, and images — into one or more languages using AI.
...
1. **Pick a folder** — point the app at a folder of documents (`.pdf`, `.docx`, `.txt`, `.md`, `.png`, `.jpg`, `.webp`, and more)
...
- **Image translation** — standalone image files (`.png`, `.jpg`, `.jpeg`, `.webp`, `.bmp`, `.tiff`) are translated via the vision API; extracted text is the output
